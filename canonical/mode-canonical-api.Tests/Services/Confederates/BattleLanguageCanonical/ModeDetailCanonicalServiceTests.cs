...
namespace mode_canonical_api.Tests.Services.Confederates.BattleLanguageCanonical
{
    public class ModeDetailCanonicalServiceTests
    {
        ...
        [Theory, AutoData]
        public async void GetByExternalId_ReturnsNull_If_ResourceNotFound(
        ...
        [Theory, AutoData]
        public async void Delete_ReturnsFalse_If_ResourceNotFound(
            ModeDetailCanonical modeDetailCanonical) {
