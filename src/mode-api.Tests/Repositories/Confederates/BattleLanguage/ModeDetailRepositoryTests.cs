...
using mode_api.Tests.Common.Confederates.BattleLanguage;
using System;
...
namespace mode_api.Tests.Repositories.Confederates.BattleLanguage
{
    public class ModeDetailRepositoryTests : BaseRepositoryTest
    {
        public ModeDetailRepositoryTests(): base(new DbContextOptionsBuilder<ApplicationContext>()
